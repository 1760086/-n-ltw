<?php
  ...
  if(isset($_GET[\'ID\']))
    ...
    header(\'Location: http://localhost:8888/MangXaHoi/\');
  $personalID = false;
  try
  {
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="position: relative;">
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul id="navheader" class="navbar-nav mr-auto" style="margin-right: 0px;position: absolute;" >
          ...
          <?php else:?>
          <li class="nav-item ">
            <a class="nav-link" href="http://localhost:8888/MangXaHoi/change_pass.php">Đổi mật khẩu</a>
          </li>

          <li class="nav-item ">
            <a class="nav-link" href="http://localhost:8888/MangXaHoi/logout.php">Đăng xuất</a>
          </li>
          <?php endif; ?>
          <li class="nav-item header_button <?php echo $page === \'index\'? \'active\':\'\'?>">
            <a class="nav-link" href="http://localhost:8888/MangXaHoi/">
              <?php
                if($page === \'index\')
                {
                  echo \'Trang chủ\';
