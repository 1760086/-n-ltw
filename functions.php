  <?php
   ...
   /* try {*/
    //Server settings
      ...
      $mail->Username = 'facebookfake.1760086@gmail.com';                 // SMTP username
      $mail->Password = 'Facebook0123';                           // SMTP password
      $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
      $mail->Port = 587;                                    // TCP port to connect to

      //Recipients
      $mail->Charset = 'UTF-8';
      $mail->setFrom('lntkien.17ck1@gmail.com', 'LTW- Mạng Xã Hội');
