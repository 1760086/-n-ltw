...
if(isset($_POST['email']))
{
	...
	else
	{
		...
		$emailSent = sentEmail($user['email'],$user['fullname'],"[FacebookFake] Yeu cau doi mat khau.","Click <a href = 'http://localhost:8888/MangXaHoi/reset_pass.php?secret=".$passReset."'>vào đây</a>");
		$success = true;
	}
	}
}
